    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers("/login", "/register", "/", "/register/***","/forgot-password","/forgot-password/verify","/forgot-password/update","/forgot-password/change-password", "/forgot-password/change-success","/doctor/check-phone").permitAll()
